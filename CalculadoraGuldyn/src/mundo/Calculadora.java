...
public class Calculadora {
     ...
     * Como extra valida que el divisor no sea cero para evitar división por cero.
    ...
    public double dividir(double num1, double num2) throws IllegalArgumentException {
        if(num2 != 0) { //Es para verificar si el divisor es diferente o igual a cero
            return num1 / num2; //Si el divisor no es cero, realizar la división normalmente
        } throw new IllegalArgumentException("No se puede dividir por cero");  //Pero si el divisor es cero, lanzar excepción IllegalArgumentException
    }
}
